...
def construct_harmful_dataset_splits():
    ...
    # for file in ['jailbreakbench.json', "malicious_instruct.json", "tdc2023.json", "advbench.json"]:
    # for file in ['salad_bench.json']:
    harmful_instructions = []
    for file in ['circuit_breakers.json']:
...
# %%
current_dir = os.path.abspath("")
splits_data_dir = os.path.join(current_dir, 'orbench_splits')
...
def construct_harmful_dataset_splits():
    ...
    random.seed(42)
    random.shuffle(harmful_instructions)
    harmful_train_instructions = harmful_instructions[:-128]  # Sample 1024 for train
    harmful_val_instructions = harmful_instructions[-128:]  # Sample 128 for val
